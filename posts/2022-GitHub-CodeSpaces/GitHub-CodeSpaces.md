...
**Note:** When using a locally installed copy of VS Code instead of the web browser, you will still be working on the remote **codespace** instance, thus you will still be utilising the remote instance compute power which may be a much higher spec than our local machine and fitting your applications requirements. Pretty neat!!!  
