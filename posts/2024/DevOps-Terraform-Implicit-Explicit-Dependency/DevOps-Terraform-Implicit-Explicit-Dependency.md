...
published: true
description: 'How Terraform builds its dependency graph with implicit and explicit dependencies, and when to use depends_on for correct resource ordering.'
