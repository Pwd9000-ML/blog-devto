...
The repository is set up as a **[GitHub template](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp)**. If you're a team lead, trainer, or community organiser, you can:

1. Click **"Use this template"** to create your own copy
2. Customise the content for your organisation or audience
3. Use the included **[Facilitator Guide](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp/blob/master/FAQ/facilitator-guide.md)** to deliver the training
...
- **[IDE Support Guide](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp/blob/master/FAQ/IDE-support.md)**, detailed information on Copilot features per IDE
- **[Participant Quickstart](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp/blob/master/FAQ/participant-quickstart.md)**, a quick reference card to get started immediately
...
> **Note**: You'll need an active [GitHub Copilot subscription](https://github.com/features/copilot/plans) (Pro, Pro+, Business, or Enterprise) to complete the hands-on labs. Copilot features vary by IDE and version. The bootcamp references the [Copilot feature matrix](https://docs.github.com/en/copilot/reference/copilot-feature-matrix) as the source of truth.
...
1. **Visit the repository**: [github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp)
...
6. **Share your progress**, tag me on [X](https://x.com/pwd9000) or [LinkedIn](https://www.linkedin.com/in/marcel-pwd9000/). I'd love to hear how it's going!

If you're a trainer or facilitator, check out the **[Facilitator Guide](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp/blob/master/FAQ/facilitator-guide.md)** and use the template to spin up your own customised version.

---

## Contributing

This bootcamp is open source under the MIT licence. If you spot improvements, have ideas for additional labs, or want to contribute prompt examples, check out the **[Contributing Guide](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp/blob/master/CONTRIBUTING.md)** and submit a pull request. Community contributions make this resource better for everyone.

---

## Conclusion

The best way to learn GitHub Copilot isn't by reading about it. It's by using it. The **[GitHub Copilot Bootcamp](https://github.com/Pwd9000-ML/GitHub-Copilot-Bootcamp)** gives you a structured, hands-on path to go from foundational understanding to advanced mastery across the entire development lifecycle: code generation, prompt engineering, DevOps automation, testing, refactoring, and responsible AI practices.
