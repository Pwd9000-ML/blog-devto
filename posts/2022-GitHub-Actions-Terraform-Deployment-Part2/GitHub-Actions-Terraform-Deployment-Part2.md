...
3. **Create Terraform Modules (Modular):** We will set up a few terraform ROOT modules. Separated and modular from each other (non-monolithic). The only difference in this part of the series will be Step 4. Instead of creating **re-usable GitHub workflows** we will be creating a normal workflow with the marketplace actions.
